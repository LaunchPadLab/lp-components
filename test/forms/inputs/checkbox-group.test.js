...
describe('CheckboxGroup', () => {
  test('adds value to array when unselected option clicked', async () => {
  ...
  test('removes value from array when selected option clicked', async () => {
    const user = userEvent.setup()
  ...
  test("has a legend with the group's name by default", () => {
    const props = {
      input: {
        name,
        value: '',
  ...
  test('does not pass class to children', () => {
    const props = {
      input: {
        name,
        value: '',
  ...
  test('with dropdown = true adds value to array when unselected option clicked', async () => {
    const user = userEvent.setup()
  ...
  test('with dropdown = true removes value from array when selected option clicked', async () => {
    const user = userEvent.setup()
  ...
  test('with dropdown = true sets menu no longer active when clicked outside', async () => {
    const user = userEvent.setup()
