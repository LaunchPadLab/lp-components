...
-   `initialAscending` **[Boolean][145]** The sort direction of the initial column (optional, default `true`)
...
-   `valueGetter` **[Function][144]?** A function that will return a cell's value derived from each data object. Will be passed the `data` for the row.
