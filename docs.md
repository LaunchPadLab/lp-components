...
-   `emptyOption` **[Boolean](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Boolean)?** A flag indicating whether or not to include an option with a value of `''` (optional, default `false`)
