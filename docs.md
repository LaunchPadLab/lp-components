...
A full list of props supported by this component can be found [here][144].

_Note: this component requires special styles in order to render correctly. To include these styles in your project, follow the directions in the main [README][145] file._
...
A group of checkboxes that can be used in a `redux-forms`-controlled form. 
Wraps the [CheckboxGroup][31] component in a [DropdownSelect][146] component, which displays the selected values as a list.
...
If `name` is used to set the text, it will be stripped of its prefixes and converted to [start case][147].

For instance: `'person.firstName'` becomes `'First Name'`

Note: When using third party form libraries (e.g., [Redux Form][148]), it's likely that setting the `required` prop will turn on the browser's automatic validation, which could cause the library to behave unexpectedly. If the browser validation behavior is causing issues, then add a `noValidate` prop to the form to [turn off][149] automatic validation. (e.g., `<form noValidate></form>`)
...
A component that displays a flash message generated by [redux-flash][150].
...
A component that displays multiple flash messages generated by [redux-flash][150].
...
A [react-router][151] `Route` component that requires an auth function to return `true` before it can be entered.
...
[144]: https://github.com/Hacker0x01/react-datepicker/blob/master/docs/datepicker.md

[145]: README.md#dateinput-styles

[146]: DropdownSelect

[147]: https://en.wikipedia.org/wiki/Letter_case#Stylistic_or_specialised_usage

[148]: https://redux-form.com

[149]: https://developer.mozilla.org/en-US/docs/Learn/HTML/Forms/Form_validation#Validating_forms_using_JavaScript

[150]: https://github.com/LaunchPadLab/redux-flash

[151]: https://github.com/ReactTraining/react-router
