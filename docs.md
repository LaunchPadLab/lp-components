...
*   `className` **([String][139] | [Object][145])** Additional class to append to the base class of the modal (modal-inner). See [React Modal's style documentation][165] for more details. (optional, default `""`)
*   `overlayClassName` **([String][139] | [Object][145])** Additional class to append to the base class of the modal overlay (modal-fade-screen). See [React Modal's style documentation][165] for more details. (optional, default `""`)
...
A function that returns a React HOC for uploading files to (Cloudinary)\[[https://cloudinary.com][166]].
...
*   `requestOptions` **[object][145]** Options for the request, as specified by (`lp-requests`)\[[https://github.com/LaunchPadLab/lp-requests/blob/master/src/http/http.js][167]]. (optional, default `DEFAULT_REQUEST_OPTIONS`)
...
[166]: https://cloudinary.com

[167]: https://github.com/LaunchPadLab/lp-requests/blob/master/src/http/http.js
